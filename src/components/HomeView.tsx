...
import { subscribeToWorkbooks, createWorkbook, addPageToWorkbook, deletePageFromWorkbook, updateWorkbook, updatePage, deleteWorkbook } from '../store';
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
              ...
              <div className="p-6 flex-1">
                <div className="flex justify-between items-start mb-2 group/title">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button
                      onClick={(e) => { e.stopPropagation(); setWorkbookToDelete(workbook.id); }}
                      className="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-md transition-colors opacity-0 group-hover/title:opacity-100"
      ...
      {workbookToDelete && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-sm">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Delete Workbook?</h2>
            <p className="text-gray-600 mb-6">Are you sure you want to delete this workbook and all its pages? This action cannot be undone.</p>
            <div className="flex justify-end gap-3">
              <button
              ...
              <button
                onClick={async () => {
                  await deleteWorkbook(workbookToDelete);
